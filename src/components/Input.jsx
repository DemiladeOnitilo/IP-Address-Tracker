...
const Input = (props) => {  
  ...
  return (
    <div className='flex justify-center'>
        <input type="text" value={props.value || ''} onChange={props.handleChange} placeholder='Search for any IP address or domain' className='border-0 rounded-l-xl bg-white w-140 h-15 pl-6 focus:outline-none' />
